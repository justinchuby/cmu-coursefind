      ...
      <div className="container">
        <div className="row">
          <div className="col s12">
            <div className="right">
              <iframe title="Github Repo" src="https://ghbtns.com/github-btn.html?user=justinchuby&repo=cmu-coursefind&type=star&count=true&size=large" frameBorder="0" scrolling="0" width="160px" height="30px"></iframe>
            </div>
          ...
          <div className="col s11">
            ...
            <p className="grey-text text-darken-2">
              <br />
              CMU Course Find was a 15-112 term project by Justin Chu (me) during the Fall 2015 semester at Carnegie Mellon University. It is still an on going project. This site is proudly using <a href="https://scottylabs.org/course-api/" target="_blank" rel="nofollow noopener noreferrer">Materialize</a>, a CSS Framework by CMU students.
            <br /><br />
            ...
            <br /><br />
              To find a course, you may search for the name of a course, name of instructors, name of a building, number of a course, or a room number. You can further view course reviews on <a href="http://cmucoursereviews.me" className="grey-text text-darken-3" target="_blank" rel="nofollow noopener noreferrer">cmucoursereviews.me</a>, also a 112 term project by Amit Nambiar.
            <br /><br />
              If you have any suggestion or if you would like to contribute to this project, please don’t hesitate to <a href="http://www.google.com/recaptcha/mailhide/d?k=01wipM4Cpr-h45UvtXdN2QKQ==&amp;c=r0MIa1Nhtz6i9zAotzfExghYzS_a8HaYrmn_MGl-GBE=" target="_blank" rel="nofollow noopener noreferrer" onClick={(e) => { e.preventDefault(); window.open('http://www.google.com/recaptcha/mailhide/d?k\x3d01wipM4Cpr-h45UvtXdN2QKQ\x3d\x3d\x26c\x3dr0MIa1Nhtz6i9zAotzfExghYzS_a8HaYrmn_MGl-GBE\x3d', '', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=500,height=300'); return false; }} title="Reveal this e-mail address">email me!</a>
              <br /><br /><br />
              Happy learning!
            <br />
              Justin
            <br /><br /><br />
              ...
              <br />
              - Watch the introduction video on <a href="https://youtu.be/QzxAUsKCtxM" target="_blank" rel="nofollow noopener noreferrer">Youtube</a>
            </p>
          </div>
        </div>
      </div>
